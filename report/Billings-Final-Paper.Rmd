...
```{r SearchTerms}
STtable <- data.frame(
  database = c("PubMed", "Web of Science"),
  search = c(
    paste(
...
All data sheets, along with cleaning and analysis code, are available on GitHub, but will remain private until publication. Materials are available upon request.
